 ...
 */
public class JamónLarhzialeNahid2122 {
    ...
    public JamónLarhzialeNahid2122 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    // jamon
    
    public JamónLarhzialeNahid2122 (String cat, double precio, int stock)
    {
        this.categoria =cat;
        this.precio=precio;
        this.stock=stock;
   ...
   // Método para asignar la categoría del jamón
    ...
    public void vender (int cantidad, String paisLarhzialeNahid2122) throws Exception
    {
        if (cantidad <= 0)
